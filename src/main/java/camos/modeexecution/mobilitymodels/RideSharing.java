...
import camos.modeexecution.mobilitymodels.modehelpers.RouteCalculationHelper;
...
import camos.modeexecution.carmodels.StandInVehicle;
    ...
    public void calculateMetrics(Ride ride) {
        ...
        if (!ride.getExtraStops().isEmpty()) {
            ...
            for (Agent a : ride.getAgents()) {
                ...
                agentToTime.put(a, (double) (long)(path.getTime()/60000L));
